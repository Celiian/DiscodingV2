        ...
        <div class="mb-10">
          ...
          <div class="flex gap-10 justify-start items-center">
            <div class="flex items-center w-1/5 px-1 rounded m-1 bg-white-300/80">
              <input :disabled="infiniteCheckboxValue" type="number" :value="inputPeopleNumber" placeholder="10" min="1"
                max="99"
            ...
            <div>
              ...
              <label class="text-white-400" for="infini">Je ne souhaite pas de
                limite</label>
            </div>
