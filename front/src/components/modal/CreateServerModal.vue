    ...
    <div ref="target" class="bg-white-600 rounded min-w-[440px] sm:w-[440px] w-full h-full sm:h-auto relative">
      ...
      <div class="pt-6 px-6 text-center">
        ...
        <div class="flex justify-center pt-1">
          ...
          <div v-else :style="{ backgroundImage: 'url(' + selectedFileUrl + ')' }"
            ...
            @click="openFileInput"></div>
        </div>

        <div class="w-full flex flex-col mt-6">
          <h3 class="mb-2 text-xs font-bold text-grey-500">NOM DU SERVEUR</h3>
          <input type="text" :placeholder="'Serveur de ' + currentUser.username"
          ...
          <p class="mt-2 pb-1 text-[#5c5e66] text-xs font-normal">
            ...
            <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" class="font-semibold text-[#00a8fc]">Charte
              d'Utilisation de mon c*l de Discord</a>.
          </p>
        </div>
      </div>
