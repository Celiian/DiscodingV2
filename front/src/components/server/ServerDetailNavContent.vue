...
<template>
    <ServerCaterogyCard v-for="category in categories" :categoryId="category._id" :categoryName="category.name"
        :channels="category.channels" />


    <ServerChannelNameCard v-for="(channel, index) in channels" :class="index === 0 ? 'mt-[20px]' : ''"
